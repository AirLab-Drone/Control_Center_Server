...
class UpSquared_Status(database.Model):
    ...
    up_squared_service = database.Column(database.Boolean, nullable=False)
    rgb_status = database.Column(database.Boolean, nullable=False)
    thermal_status = database.Column(database.Boolean, nullable=False)
